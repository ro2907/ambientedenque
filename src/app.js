...
function preload ()
{
    ...
    this.load.spritesheet('star', 'assets/basura3.png',{ frameWidth: 56, frameHeight: 50 });
    this.load.spritesheet('bomb', 'assets/mosq2.png',{ frameWidth: 72, frameHeight: 60 });
...
function create ()
{
    ...
    this.add.image(568,325, 'sky'); //Los valores 400 y 300 son las coordenadas x e y de la imagen. ¿Por qué 400 y 300? Es porque en Phaser 3 todos los Game Objects están posicionados en su centro por defecto. La imagen de fondo tiene un tamaño de 800 x 600 píxeles
    ...
    player = this.physics.add.sprite(100, 450, 'dude').setScale(1.3).refreshBody();
...
//     if (player.x - child.x < 0) {
//         child.setOrigin(0.5, 0.5);
//         child.setScale(1, 1); // Sin invertir la escala (imagen normal)
//       } else if (player.x - child.x > 0) {
//         child.setOrigin(0.5, 0);
//         child.setScale(-1, 1); // Invertir la escala horizontalmente (imagen espejo)
//       }
//   });
//   bombAnimation
//   bombs.children.iterate(function (bomb) {
    // Verificar la condición para cambiar la animación
//     if (player.x - child.x < 0) {
//       bomb.anims.play('bombAnimation');
//     } else {
//       bomb.anims.play('bombAnimation2');
//     }
//   });
